...
from models import spfsa as sp
from SparkMET.codes import m as m
...
class SparkMET():
    ...
    def compile(self, optmizer: str, loss: str, lr: float, wd:float, ):
        ...
        self.model = vit.Factorized_VisionTransformer(self.SparkMET_Configs, img_size = 32, num_classes=2,).to(device)
        # self.model = sp.ViT(image_size = 32,
        # image_patch_size = 8,
        # frames = 388,
        # frame_patch_size = 97,
        # num_classes = 2,
